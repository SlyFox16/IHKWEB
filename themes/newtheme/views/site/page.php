            ...
            <?php if ($model->id == 1) { ?>
                <div class="row bottom-50">
                    <div class="medium-4 columns">
                        ...
                        <p>Deutscher Crowdsourcing Verband e.V.</p>
                        <p>
                            Vereinsanschrift:
                        ...
                        <p>E-Mail: info@crowdsourcingverband.de</p>
                        <p>Der DCV e.V. ist beim Amtsgericht Charlottenburg unter der VR Nummer 34911 eingetragen.</p>
                    </div>
                    <div class="medium-4 columns">
                    ...
                    <div class="medium-4 columns">
                        ...
                        <p>Deutscher Crowdsourcing Verband e.V.</p>
                        <p>
                            IBAN: DE80 1005 0000 0190 3084 43
                            BIC: BELADEBEXXX
                            Berliner Sparkasse
                        </p>
                    </div>
                    ...
                    <div class="medium-12 columns">
                        <ul class="accordion" data-accordion data-allow-all-closed="true">
                            <li class="accordion-item" data-accordion-item>
                                <a href="#" class="accordion-title">Inhalt des Onlineangebotes</a>
                                <div class="accordion-content" data-tab-content>
                                    <p>
                                        Die Autoren übernehmen keinerlei Gewähr für die Aktualität, Korrektheit, Vollständigkeit oder Qualität der bereitgestellten Informationen, der angebotenen Online-Scans oder Downloads, die nicht aus eigenen Quellen stammen.
                                        Haftungsansprüche gegen die Autoren, welche sich auf Schäden materieller oder ideeller Art beziehen, die durch die Nutzung oder Nichtnutzung der dargebotenen Informationen bzw. durch die Nutzung fehlerhafter und unvollständiger Informationen verursacht wurden, sind grundsätzlich ausgeschlossen, sofern seitens des Autors kein nachweislich vorsätzliches oder grob fahrlässiges Verschulden vorliegt.
                                        Alle Angebote sind freibleibend und unverbindlich. Die Autoren behält es sich ausdrücklich vor, Teile der Seiten oder das gesamte Angebot ohne gesonderte Ankündigung zu verändern, zu ergänzen, zu löschen oder die Veröffentlichung zeitweise oder endgültig einzustellen.
                                    </p>
                                </div>
                            </li>
                            <li class="accordion-item" data-accordion-item>
                                <a href="#" class="accordion-title">Verweise und Links</a>
                                <div class="accordion-content" data-tab-content>
                                    <p>Bei direkten oder indirekten Verweisen auf fremde Webseiten (“Hyperlinks”), die außerhalb des Verantwortungsbereiches des Autors liegen, würde eine Haftungsverpflichtung ausschließlich in dem Fall in Kraft treten, in dem die Autoren von den Inhalten Kenntnis hat und es ihm technisch möglich und zumutbar wäre, die Nutzung im Falle rechtswidriger Inhalte zu verhindern.
                                    Die Autoren erklärt hiermit ausdrücklich, dass zum Zeitpunkt der Linksetzung keine illegalen Inhalte auf den zu verlinkenden Seiten erkennbar waren. Auf die aktuelle und zukünftige Gestaltung, die Inhalte oder die Urheberschaft der gelinkten/verknüpften Seiten hat der Autor keinerlei Einfluss. Deshalb distanziert er sich hiermit ausdrücklich von allen Inhalten aller gelinkten /verknüpften Seiten, die nach der Linksetzung verändert wurden. Für illegale, fehlerhafte oder unvollständige Inhalte und insbesondere für Schäden, die aus der Nutzung oder Nichtnutzung solcherart dargebotener Informationen entstehen, haftet allein der Anbieter der Seite, auf welche verwiesen wurde, nicht derjenige, der über Links auf die jeweilige Veröffentlichung lediglich verweist.</p>
                                </div>
                            </li>
                            <li class="accordion-item" data-accordion-item>
                                <a href="#" class="accordion-title">Datenschutz</a>
                                <div class="accordion-content" data-tab-content>
                            ...
                            <li class="accordion-item" data-accordion-item>
                                <a href="#" class="accordion-title">Urheberrecht</a>
                                <div class="accordion-content" data-tab-content>
                                    <p>Der Betreiber der Seiten ist bemüht, stets die Urheberrechte anderer zu beachten bzw. auf selbst erstellte sowie lizenzfreie Werke zurückzugreifen.</p>
                                    <p>Die durch den Seitenbetreiber erstellten Inhalte und Werke auf diesen Seiten unterliegen dem deutschen Urheberrecht. Beiträge Dritter sind als solche gekennzeichnet. Die Vervielfältigung, Bearbeitung, Verbreitung und jede Art der Verwertung außerhalb der Grenzen des Urheberrechtes bedürfen der schriftlichen Zustimmung des jeweiligen Autors bzw. Erstellers. Downloads und Kopien meiner Seite sind nur für den privaten, nicht kommerziellen Gebrauch gestattet und dürfen nicht anderen öffentlich (ohne meine vorherige schriftliche Zustimmung) zugänglich gemacht werden.</p>
                                </div>
                            </li>
                            <li class="accordion-item" data-accordion-item>
                                <a href="#" class="accordion-title">Webanalysedienst – Google Analytics – Datenschutzpolicy</a>
                                <div class="accordion-content" data-tab-content>
                            ...
                            <li class="accordion-item" data-accordion-item>
                                ...
                                <div class="accordion-content" data-tab-content>
                                    ...
                                    <p>Ebenfalls ist es möglich Facebook-Social-Plugins mit Add-ons für Ihren Browser zu blocken, zum Beispiel mit dem “Facebook Blocker“. – (Quelle: spreerecht.de)</p>
                                </div>
                            </li>
                            <li class="accordion-item" data-accordion-item>
                                <a href="#" class="accordion-title">Verwendung der Social-Funktionen von Shareholic („Weitersagen heißt Unterstützen Slogan“) bzw. der dazugehörigen Social-Network Schaltflächen</a>
                                <div class="accordion-content" data-tab-content>
                                    <p>Mein Internetauftritt benutzt das Social Plugin der Firma Shareaholic Inc. und die Shareaholic-Funktionen, welche von der Shareaholic, c/o Performable Inc., 486 Green Street, Cambridge, MA 02139, USA angeboten werden.</p>
                                    <p>
                                        Mit dem Social Plugin der Firma Shareaholic Inc. ist es dem Besucher meiner Webseiten möglich, meine Artikel bzw. die Webseiten meines Internetauftritts in diverse soziale Netzwerke zu teilen, bzw. anderen Personen mit diesem Diensten zur Verfügung zu stellen.
                                        Wenn Sie eine Webseite meines Internetauftritts aufrufen, die eine solche Funktion enthält, baut Ihr Browser eine direkte Verbindung mit den Servern von Shareaholic, Inc. auf. Der Inhalt des genannten Social Plugins wird direkt an Ihren Browser übermittelt und von diesem in meine Webseiten mit eingebunden. Ich habe  daher keinen Einfluss auf den Umfang der Daten, die Shareaholic Inc. mit Hilfe dieses Plugins erhebt und informiere Sie daher entsprechend meinem Kenntnisstand. Nach diesem wird lediglich die IP-Adresse Ihrer Verbindung sowie die URL meiner Seite beim Bezug der „Weitersagen heißt Unterstützen“ Schaltflächen mit übermittelt, aber nicht für andere Zwecke, als die Darstellung der diversen Buttons und des Sogans („Weitersagen heißt Unterstützen“), genutzt.
                                    </p>
                                    <p>
                                        Wenn Sie als Nutzer der jeweiligen sozialen Netzwerke „angemeldet, bzw. dort eingeloggt“ sind, wird diese Interaktion auf dem jeweiligen sozialen Netzwerk zu Ihrem Profil zugeordnet und angezeigt. Folgende Daten werden als „eingeloggter User“ übertragen:
                                    </p>
                                    <ul>
                                        <li>Als Referrer die URL unserer zuvor von Ihnen geöffneten Seite, auf die das „Social Plugin“ der Firma Shareaholic Inc. Bezug nimmt.</li>
                                        <li>Ihre IP-Adresse</li>
                                        <li>Ihre User-ID des jeweiligen sozialen Netzwerks</li>
                                        <li>Datum und Uhrzeit des Besuchs</li>
                                    </ul>
                                    <p>Eine weitergehende Speicherung und Weitergabe Ihrer persönlichen Daten durch mich findet nicht statt.
                                    Weitere Details zum Social Plugin der Firma Shareaholic Inc. können Sie auf den folgenden Seiten des Herstellers entnehmen:</p>
                                </div>
                            </li>
                            <li class="accordion-item" data-accordion-item>
                                <a href="#" class="accordion-title">Verwendung des Google Plus 1 Buttons (“+1″ Schaltfläche)</a>
                                <div class="accordion-content" data-tab-content>
                                    <p>Mein Internetauftritt verwendet die „+1“-Schaltfläche des sozialen Netzwerkes Google, welches von der Google Inc., 1600 Amphitheatre Parkway, Mountain View, CA 94043 betrieben wird. Die Schaltfläche ist mit einem „+1″ gekennzeichnet. Die „+1“ Schaltfläche ist ein Kürzel für “das ist ziemlich cool” oder “schau dir das an”. Die Schaltfläche wird nicht verwendet, um Ihre Besuche im Web zu erfassen.</p>
                                    <p>
                                    ...
                                    <p>Eine weitergehende Auswertung Ihres Besuchs der Websites meines Internetauftrittes mit einer „+1“-Schaltfläche erfolgt nicht.</p>
                                    ...
                                    <p>Weitere Hinweise zum Datenschutz bei der Nutzung der +1-Schaltfläche finden Sie unter dem Link https://www.google.com/intl/de/+/policy/+1button.html.</p>
                                    <p>Die Klausel zur Verwendung der Google „+1“-Schaltfläche wurde von der Kanzlei Gerstel erstellt und ist unter http://www.abmahnberatung.de zu finden.</p>
                                </div>
                            </li>
                            <li class="accordion-item" data-accordion-item>
                                <a href="#" class="accordion-title">Verwendung von Twitter Re-Tweet-Funktionen („Tweet“ Schaltfläche)</a>
                                <div class="accordion-content" data-tab-content>
                                    <p>Mein Internetauftritt benutzt Twitter und die Twitter Re-Tweet-Funktionen, welche von der Twitter Inc., 795 Folsom St., Suite 600, San Francisco, CA 94107, USA angeboten werden. Mit dem Re-Tweet-Button („Tweet“) ist es Twitternutzern möglich, meine Artikel bzw. die Webseiten meines Internetauftritts über Twitter zu teilen, bzw. anderen Personen auf Twitter zur Verfügung zu stellen.</p>
                                    <p>
                                    ...
                                    <ul>
                                        <li>Als Referrer die URL unserer zuvor von Ihnen geöffneten Seite, auf die das „Re-Tweet“-Plugin Bezug nimmt.</li>
                                        <li>Ihre IP-Adresse</li>
                                        <li>Ihre User-ID</li>
                                        <li>Datum und Uhrzeit des Besuchs</li>
                                    </ul>
                                    <p>Details zum Umgang mit Ihren Daten durch Twitter sowie zu Ihren Rechten und Einstellungsmöglichkeiten zum Schutz Ihrer persönlichen Daten können Sie den Datenschutzhinweisen von Twitter entnehmen.</p>
                                </div>
                            </li>
                            <li class="accordion-item" data-accordion-item>
