...
class DToggleColumn extends CGridColumn
{
    ...
    protected function registerClientScript()
    {
        ...
        $style = "
            .toggle-link .con-on, .toggle-link .con-off {display:block; margin:0 auto;}
            .toggle-link .con-on {display:none;}
            .toggle-link .con-off {display:block;}
            .toggle-link.toggle-true .con-on {display:block !important;}
            .toggle-link.toggle-true .con-off {display:none !important;}
        ";
    ...
    protected function renderDataCellContent($row,$data)
    {
        ...
        if ($visible)
        {
            ...
            $onImage = CHtml::image($this->onImageUrl, $this->titles[1], array('title'=>$this->titles[1], 'style'=>$iconStyle, 'class'=>'con-on'));
            $offImage = CHtml::image($this->offImageUrl, $this->titles[0], array('title'=>$this->titles[0], 'style'=>$iconStyle, 'class'=>'con-off'));
