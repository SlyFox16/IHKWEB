...
<div class="control-group ">
    ...
    <div class="controls">
        ...
        <div class="input-append date" id="<?php echo CHtml::activeId($model, $attribute) . "_datepicker"; ?>"
             data-date="<?php echo $model->$attribute; ?>" data-date-format="<?php echo $dateFormat; ?>"<?php if(isset($htmlOptions['viewMode'])): ?> data-date-viewmode="<?php echo $htmlOptions['viewMode']; ?>"<?php endif; ?>>
