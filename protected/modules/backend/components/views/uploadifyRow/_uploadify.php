...
<script type="text/javascript">
    ...
    $().ready(function () {
        ...
        $(uploadify_id).uploadify({
            ...
            'script':'<?php echo Yii::app()->createUrl("backend/" . lcfirst(get_class($model)) . "/upload"); ?>',
            ...
            'onAllComplete':function () {
                ...
                $.ajax({
                    ...
                    url:"<?php echo Yii::app()->createUrl("backend/" . lcfirst(get_class($model)) . "/gallery"); ?>",
        ...
        $(".delete").live("click", function () {
            ...
            $.ajax({
                ...
                url:"<?php echo Yii::app()->createUrl("backend/" . lcfirst(get_class($model)) . "/imagedel"); ?>",
