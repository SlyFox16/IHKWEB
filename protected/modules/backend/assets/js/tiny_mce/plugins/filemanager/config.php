<?php
        ...
        $mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mp3,mpg,mpeg,asf,flv,doc,docx,xls,xlsx";
        ...
        $mcFileManagerConfig['upload.extensions'] = "gif,jpg,mp3,png,pdf,zip,doc,docx,xls,xlsx";
        ...
        $mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,mp3,pdf,txt,zip,doc,docx,xls,xlsx";
