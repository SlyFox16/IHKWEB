...
class DateTimePicker extends CJuiInputWidget
{
    ...
    public function run()
    {
        Yii::app()->clientScript->registerCssFile(Yii::app()->request->baseUrl.'/static/css/jquery-ui-timepicker-addon.css');
        Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl.'/static/js/jquery-ui-timepicker-addon.js', CClientScript::POS_END);
