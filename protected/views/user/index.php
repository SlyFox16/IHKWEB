            ...
            <div class="row">
                <div class="panel panel-transparent">
                    <ul class="nav nav-tabs nav-tabs-simple nav-tabs-left bg-white" id="tab-3">
                        <li class="active">
                            <a data-toggle="tab" href="#tab3hellowWorld">Профиль</a>
                        </li>
                        <li class="">
                            <a data-toggle="tab" href="#tab3FollowUs">История заказов</a>
                        </li>
                        <li class="">
                            <a data-toggle="tab" href="#tab3Inspire">Пополнить баланс</a>
                        </li>
                    </ul>
                        ...
                        <div class="tab-pane active" id="tab3hellowWorld">
                            <div class="row column-seperation">
                                <div class="col-md-6">
                                    ...
                                    <p>Ваша профильная информация отражает то, как вы будете представлены на сайте. Рекомендуем использовать реальные имя и email.</p>
                                    <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <?php echo $form->textField($model, 'name', array('class' => 'form-control', 'placeholder' => "Петр")); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="row">
                                                <?php echo $form->textField($model, 'surname', array('class' => 'form-control', 'placeholder' => "Иванов")); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <?php echo $form->textField($model, 'email', array('class' => 'form-control', 'placeholder' => "office@mail.com")); ?>
                                            <?php echo $form->error($model, 'email'); ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <?php $this->widget('AjaxFileLoader', array('id' => 'user-form-change', 'model' => $model)); ?>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <button type="submit" class="btn btn-success"><?php echo Yii::t("base", "Сохранить"); ?></button>
                                        <button id="btnToggleSlideUpSize" class="btn btn-green btn-lg pull-right bottom-right"><?php echo Yii::t("base", "Смерить пароль"); ?></button>
                                    </div>
                                    <?php $this->endWidget(); ?>
                                </div>
                                <div class="col-md-6">
        ...
        <li class="chat-user-list clearfix">
            <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/1x.jpg" data-src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/1.jpg" src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/1x.jpg" class="col-top">
                        </span>
                        </span>
    ...
    <ul>
        ...
        <li class="chat-user-list clearfix">
            <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/2x.jpg" data-src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/2.jpg" src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/2x.jpg" class="col-top">
                        </span>
                        </span>
                <p class="p-l-10 col-xs-height col-middle col-xs-12">
        ...
        <li class="chat-user-list clearfix">
            <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/3x.jpg" data-src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/3.jpg" src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/3x.jpg" class="col-top">
                        </span>
                        </span>
                <p class="p-l-10 col-xs-height col-middle col-xs-12">
    ...
    <ul>
        ...
        <li class="chat-user-list clearfix">
            <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/4x.jpg" data-src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/4.jpg" src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/4x.jpg" class="col-top">
                        </span>
                        </span>
                <p class="p-l-10 col-xs-height col-middle col-xs-12">
        ...
        <li class="chat-user-list clearfix">
            <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/5x.jpg" data-src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/5.jpg" src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/5x.jpg" class="col-top">
                        </span>
                        </span>
                <p class="p-l-10 col-xs-height col-middle col-xs-12">
    ...
    <ul>
        ...
        <li class="chat-user-list clearfix">
            <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/6x.jpg" data-src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/6.jpg" src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/6x.jpg" class="col-top">
                        </span>
                        </span>
                <p class="p-l-10 col-xs-height col-middle col-xs-12">
        ...
        <li class="chat-user-list clearfix">
            <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/7x.jpg" data-src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/7.jpg" src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/7x.jpg" class="col-top">
                        </span>
                        </span>
                <p class="p-l-10 col-xs-height col-middle col-xs-12">
    ...
    <ul>
        ...
        <li class="chat-user-list clearfix">
            <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/8x.jpg" data-src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/8.jpg" src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/8x.jpg" class="col-top">
                        </span>
                        </span>
                <p class="p-l-10 col-xs-height col-middle col-xs-12">
        ...
        <li class="chat-user-list clearfix">
            <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/9x.jpg" data-src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/9.jpg" src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/9x.jpg" class="col-top">
                        </span>
                        </span>
                <p class="p-l-10 col-xs-height col-middle col-xs-12">
    ...
    <div class="chat-inner" id="my-conversation">
        ...
        <div class="message clearfix">
            <div class="profile-img-wrapper m-t-5 inline">
                <img class="col-top" width="30" height="30" src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/avatar_small.jpg" alt="" data-src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/avatar_small.jpg" data-src-retina="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/avatar_small2x.jpg">
            </div>
...
<div class="overlay hide" data-pages="search">
    ...
    <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
            <!-- BEGIN Overlay Logo !-->
            <img class="overlay-brand" src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/logo.png" alt="logo" data-src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/logo.png" data-src-retina="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/logo_2x.png" width="109" height="22">
            <!-- END Overlay Logo !-->
            <!-- BEGIN Overlay Close !-->
        ...
        <div class="container-fluid">
            ...
            <input id="overlay-search" class="no-border overlay-search bg-transparent" placeholder="Поиск..." autocomplete="off" spellcheck="false">
            <br>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            ...
                            <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                                <div>
                                    <img width="50" height="50" src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/avatar.jpg" data-src="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/avatar.jpg" data-src-retina="<?php echo Yii::app()->request->baseUrl; ?>/static/assets/img/profiles/avatar2x.jpg" alt="">
                                </div>
                            </div>
