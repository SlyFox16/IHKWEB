    ...
    <div class="container relative">
        ...
        <div class="row">
            ...
            <div class="col-md-5 separator">
                ...
                <?php $this->endWidget(); ?>
                <a href="" class="angle top-15" data-toggle="modal" data-target="#passrecover">Forgot password ?</a>
            </div>
            <div class="col-md-4">
...
<div data-notify="container" class="notification notification-{0}" role="alert">
